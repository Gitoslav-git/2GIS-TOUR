...
7. В Москве проверьте запрос «от МЦК Кутузовская в сторону центра 2 часа, идти до локаций недалеко»: первый переход должен начинаться от найденной станции, а не от центра города.

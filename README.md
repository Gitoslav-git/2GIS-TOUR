...
Это исходники первого рабочего этапа `0.1` на пути к полному MVP `1.0`. Главный источник требований для разработки — `docs/source/2ГИС Системная аналитика.docx`; она имеет приоритет над ранее присланными скриншотами бизнес-требований. Принятое значение N = 75 м и оставшиеся открытые вопросы — `docs/DECISIONS.md`, последовательность выпусков — `docs/RELEASES.md`.

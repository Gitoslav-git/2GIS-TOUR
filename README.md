...
## Что проверять в 0.5.1

1. Запустите backend и задайте геопозицию эмулятора в Туле, Владимире или Москве.
2. Нажмите **«Обновить геопозицию»**: приложение должно показать свежие координаты и точность.
